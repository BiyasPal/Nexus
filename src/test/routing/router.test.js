...
describe('createRouter - path matching', () => {
...
describe('createRouter - host-based routing', () => {
...
describe('createRouter - stretch features', () => {
...
describe('createRouter - match result shape', () => {
