...
describe('pingBackend', () => {
  test('resolves ok true for a 2xx response', async (t) => {
  ...
  test('resolves ok false for a 5xx response', async (t) => {
    t.mock.method(http, 'get', (url, options, callback) => {
  ...
  test('resolves ok false on connection error', async (t) => {
    let errorHandler;
  ...
  test('destroys the request and resolves ok false on timeout', async (t) => {
    let timeoutHandler;
    let errorHandler;
    let destroyed = false;
    t.mock.method(http, 'get', () => {
  ...
  test('uses https for https backends', async (t) => {
...
describe('createHealthChecker - status tracking', () => {
...
describe('createHealthChecker - manual reporting', () => {
...
describe('createHealthChecker - snapshot', () => {
...
describe('createHealthChecker - start/stop polling', () => {
